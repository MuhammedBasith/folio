  ...
  return (
    <input
      ...
      className={cn(
        ...
        "transition-[border-color,box-shadow] duration-160 ease-out-quint",
        "hover:border-line-strong/30",
        "focus-visible:border-line-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--focus-ring)/12",
